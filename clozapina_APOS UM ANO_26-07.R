...
clozapina$neutropenia1000_after_one_year <- revalue(clozapina$neutropenia1000_after_one_year, c(Yes = "TRUE", No = "FALSE"))
clozapina$neutropenia1000_after_one_year <- as.logical(clozapina$neutropenia1000_after_one_year)

clozapina$neutropenia1500_after_one_year <- revalue(clozapina$neutropenia1500_after_one_year, c(Yes = "TRUE", No = "FALSE"))
clozapina$neutropenia1500_after_one_year <- as.logical(clozapina$neutropenia1500_after_one_year)

clozapina$neutropenia2000_after_one_year <- revalue(clozapina$neutropenia2000_after_one_year, c(Yes = "TRUE", No = "FALSE"))
clozapina$neutropenia2000_after_one_year <- as.logical(clozapina$neutropenia2000_after_one_year)
...
clozapina$days_after_1year_neutropenia1000 <- as.numeric(clozapina$days_after_1year_neutropenia1000)
clozapina$days_after_1year_neutropenia1500 <- as.numeric(clozapina$days_after_1year_neutropenia1500)
clozapina$days_after_1year_neutropenia2000 <- as.numeric(clozapina$days_after_1year_neutropenia2000)
...
#####1000####
km_fit1000 <- survfit(Surv(days_after_1year_neutropenia1000, neutropenia1000_after_one_year) ~ CLOZAPINA_RECEITA, data=clozapina)
summary(km_fit1000)$table
autoplot(km_fit1000)
surv_summary(km_fit1000) #tabela 
head(km_fit1000)
#Log-rank test
surv_diff1000 <- survdiff(Surv(days_after_1year_neutropenia1000, neutropenia1000_after_one_year) ~ CLOZAPINA_RECEITA, data = clozapina)
surv_diff1000
...
clozapina$CLOZAPINA_RECEITA <- as.logical(clozapina$CLOZAPINA_RECEITA)
cox_1000 <- coxph(Surv(days_after_1year_neutropenia1000, neutropenia1000_after_one_year) ~  SEXO1 + IDADE_ATEND + Etnia1 + Clozapina_receita1, 
...
#### 1500 ####
km_fit1500 <- survfit(Surv(days_after_1year_neutropenia1500, neutropenia1500_after_one_year) ~ CLOZAPINA_RECEITA, data=clozapina)
summary(km_fit1500)$table
autoplot(km_fit1500)
surv_summary(km_fit1500) #tabela 
head(km_fit1500)
#Log-rank test
surv_diff1500 <- survdiff(Surv(days_after_1year_neutropenia1500, neutropenia1500_after_one_year) ~ CLOZAPINA_RECEITA, data = clozapina)
surv_diff1500
...
#cox regression
cox_1500 <- coxph(Surv(days_after_1year_neutropenia1500, neutropenia1500_after_one_year) ~  SEXO1 + IDADE_ATEND + Etnia1 + Clozapina_receita1, 
                  data = clozapina) #vejo a hazard ratio em exp(-coef)
cox_1500
summary(cox_1500)

######20000#####
km_fit2000 <- survfit(Surv(days_after_1year_neutropenia2000, neutropenia2000_after_one_year) ~ CLOZAPINA_RECEITA, data=clozapina)
summary(km_fit2000)$table
autoplot(km_fit2000)
surv_summary(km_fit2000) #tabela 
head(km_fit2000)
#Log-rank test
surv_diff2000 <- survdiff(Surv(days_after_1year_neutropenia2000, neutropenia2000_after_one_year) ~ CLOZAPINA_RECEITA, data = clozapina)
surv_diff2000
