...
#write_sav(dt_info, "clozapina.26-06-01.sav")
library(haven)
cloza_2000 <- read_sav("cloza-1500.sav")
clozapina <- cloza_2000
library(haven)
clozapina1500 <- read_sav("novobanco.sav")
...
clozapina1500$CLOZAPINA_RECEITA <- revalue(clozapina1500$CLOZAPINA_RECEITA, c(Yes = "TRUE", No = "FALSE"))
clozapina1500$CLOZAPINA_RECEITA <- as.logical(clozapina1500$CLOZAPINA_RECEITA)

clozapina$neutropenia_2000 <- as.numeric(clozapina$neutropenia_2000)
clozapina1500$neutropenia1500_1999 <- as.numeric(clozapina1500$neutropenia1500_1999)
...
km_fit1500and1999 <- survfit(Surv(days_until_neutrofilos1500and1999, neutropenia1500_1999) ~ CLOZAPINA_RECEITA, data=clozapina1500)
summary(km_fit1500and1999)$table
autoplot(km_fit1500and1999)
surv_summary(km_fit1500and1999) #tabela 
head(km_fit1500and1999)
#Log-rank test
km_fit1500and1999 <- survdiff(Surv(days_until_neutrofilos1500and1999, neutropenia1500_1999) ~ CLOZAPINA_RECEITA, data = clozapina1500)
km_fit1500and1999


km_fit1000 <- survfit(Surv(days_after_1year_neutropenia1000, neutropenia1000_after_one_year) ~ CLOZAPINA_RECEITA1, data=clozapina)
summary(km_fit1000)$table
autoplot(km_fit1000)
print(km_fit1000)

#Log-rank test
surv_diff_1000 <- survdiff(Surv(days_after_1year_neutropenia1000, neutropenia1000_after_one_year) ~ CLOZAPINA_RECEITA, data = clozapina)
surv_diff_1000


km_fit2000 <- survfit(Surv(days_until_healthy2000, neutropenia_2000) ~ CLOZAPINA_RECEITA, data=clozapina)
summary(km_fit2000)$table
autoplot(km_fit2000)
print(km_fit2000)

#Log-rank test
surv_diff_2000 <- survdiff(Surv(days_after_1year_neutropenia2000, neutropenia2000_after_one_year) ~ CLOZAPINA_RECEITA1, data = clozapina)
surv_diff_2000
